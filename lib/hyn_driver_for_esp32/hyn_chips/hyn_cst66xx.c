...
static const struct hyn_chip_series hyn_6xx_fw[] = {
    {0xCACA220E,0xffffffff,"cst3530",(u8*)fw_cst3530},//if PART_NO_EN==0 use default chip
...
static int cst66xx_prox_handle(u8 cmd)
{
    ...
    switch(cmd){
        case 1: //enable
            ...
            ret = hyn_wr_reg(hyn_66xxdata,0xD004B01,4,NULL,0);
            break;
        case 0: //disable
            hyn_66xxdata->prox_is_enable = 0;
            hyn_66xxdata->prox_state = 0xAA;
            ret = hyn_wr_reg(hyn_66xxdata,0xD004B00,4,NULL,0);
            break;
        default: 
            break;
    }
